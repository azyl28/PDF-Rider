"""
PDF Rider Nex - Zakładka PDF Master
Kompletna wersja ze wszystkimi funkcjami:
- scalanie PDF, zapisywanie, zabezpieczanie hasłem
- podpisy (wizualny + weryfikacja)
- OCR, ekstrakcja obrazów, kompresja
- poprawione okienka dialogowe (czarny tekst)
- dodawanie stron z wyborem pozycji
- przewijanie całego PDF w głównym podglądzie
- synchronizacja z miniaturami
"""

from PyQt5.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QSplitter,
    QFileDialog, QMessageBox, QScrollArea, QTabWidget, QFrame, QDialog,
    QLineEdit, QCheckBox, QTextEdit, QColorDialog, QFontDialog, QSpinBox,
    QComboBox, QProgressBar, QApplication, QInputDialog, QButtonGroup
)
